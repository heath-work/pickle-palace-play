...
const Hero = () => {
  return (
    <div className="relative bg-gray-50 overflow-hidden">
      {/* Background pattern */}
      <div className="absolute inset-0 bg-gradient-to-br from-pickleball-blue/10 to-pickleball-green/10 z-0"></div>
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <Link to="/booking">
                    <Button className="w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-white bg-pickleball-blue hover:bg-blue-600 md:py-4 md:text-lg md:px-10">
                      Book a Court
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link to="/membership">
                    <Button variant="outline" className="w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-pickleball-blue bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
                      View Memberships
                    </Button>
                  </Link>
                </div>
